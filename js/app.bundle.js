    ...
    (()=>{
        ...
        function he(e) {
            return t.createElement("svg", le({
                ...
                d: "M73.722 130.313l182.524-105.41 182.524 105.41-182.524 105.409zM461.905 170.955l.025 210.775-182.548 105.366-.025-210.775zM232.618 487.096L50.07 381.73l.025-210.775 182.548 105.366z"
            })))
        }
        function me(e) {
            return t.createElement("svg", le({
        ...
        async function Te(e) {
            ...
            try {
                ...
                if ("AbortError" === e.name)
                    return;
                const t = "An error occured trying to open the file.";
                console.error(t, e),
                alert(t)
            }
            try {
        ...
        const je = ({setClip: e, clip: n})=>{
            ...
            return t.createElement("div", {
                ...
                className: "text-xl flex justify-center items-center bg-green-500 "
            }, t.createElement("div", {
        ...
        , "单击鼠标中键 (或者", ()=>t.createElement("div", {
            className: "border border-gray-300 rounded-lg mx-2"
        }, "Ctrl"), " + ", me, " 右击) + 拖"]], " ", "模型工具栏", [["草图", J], ["在选定平面上或在现有模型中由三个选定点定义的平面上启动新草图。."]], [["挤出", se], ["初始化新的拉伸对话框。然后单击此按钮。用户必须首先选择要从中挤出的草图"]], [["联合", be], ["创建一个新实体，该实体是两个选定实体的布尔并集。."]], [["减去", ve], ["创建一个新实体，该实体是从第一个实体减去第二个选定实体的布尔值"]], [["交集", de], ["创建一个新实体，该实体是布尔交点或两个选定实体。."]], [["新文档", B], ["擦除当前工作区并启动新文档"]], [["保存", U], ["保存当前文档。在初始保存时，用户可以指定保存位置和文件名"]], [["打开", H], ["从本地磁盘加载现有文档。."]], [["导出到STL", ge], ["将所选实体导出为3d打印机友好的STL格式"]], " ", "草图工具栏", [["挤出", se], ["从当前草图创建新的拉伸"]], [["线", pe], [" 启动线段链。随后在画布上单击可定义线段链的顶点。."]], [["弧", oe], ["在随后的3次鼠标单击中,第一次设置起点,第二次设置终点,第三次设置半径。"]], [["尺寸", ue], ["添加2个点之间的距离，或1个点和1条线之间的距离。选择两条线时添加角度。"]], [["重合", ie], ["在两个点或一条线和一个点之间添加重合的约束。"]], [["垂直的", we], ["将选定的直线或两个选定的点与y轴对齐"]], [["水平", fe], ["将选定的直线或两个选定的点与x轴对齐"]], [["切线", ye], ["添加两个选定圆弧或直线和圆弧之间的相切。实体必须通过一个端点彼此重合"]]]
          , Re = [["basic-workflow.mp4", "基础操作"], ["load-file-and-edit.mp4", "加载一个编辑部分"], ["export-to-3dprint.mp4", "导出零件以进行三维打印"], ["./js/迷你卡车.json.gz", "金宇陶手搓零件"]]
          , De = new TextDecoder
          , $e = ({setModal: e})=>{
            const n = b()
              , [r,a] = (0,
            ...
            return t.createElement("div", {
                ...
                className: "absolute -top-7 w-full text-xl flex justify-center items-center bg-green-500"
            }, t.createElement("div", {
                className: "text-gray-50"
            }, "快速开始"), t.createElement(K, {
                className: "absolute cursor-pointer text-gray-50 hover:text-gray-400 right-1",
                onClick: ()=>e(null)
        ...
        const Ae = [["这是金宇陶jyt的CAD平台。","./images/uestc.jpg"],["勾画出你想要的二维结构.", "./images/sketch.mp4"], ["将草图拉伸为三维实体.", "./images/extrude.png"], ["使用额外的草图雕刻模型.", "./images/sculpt.gif"], ["将你的设计导出到3D打印机并将其变成现实!", "./images/3dprint.mp4"]]
          ...
          , He = ()=>{
            const e = b()
              ...
              , u = t=>{
                if (2 != sce.selected.length || !sce.selected.every((e=>"mesh" == e.userData.type)))
                    return void alert("please first select two bodies for boolean operation");
            ...
            }), "挤出"], [pe, ()=>sce.activeSketch.command("line"), "Line (l)"], [oe, ()=>sce.activeSketch.command("arc"), "Arc (a)"], [ue, ()=>sce.activeSketch.command("dimension"), "Dimension (d)"], [ie, ()=>sce.activeSketch.command("coincident"), "Coincident (c)"], [we, ()=>sce.activeSketch.command("vertical"), "Vertical (v)"], [fe, ()=>sce.activeSketch.command("horizontal"), "Horizontal (h)"], [ye, ()=>sce.activeSketch.command("tangent"), "Tangent (t)"], [U, async()=>Oe(a, JSON.stringify([id, sce.sid, sce.mid, n]), e, o), "保存"]]
              , f = [[J, ()=>{
            ...
            , "草稿"], [se, ()=>{
                try {
                    ...
                    console.error(e),
                    alert("请从左侧窗格挤出中选择一个草图")
                }
            }
            , "挤出"], [be, ()=>u("u"), "集合"], [ve, ()=>u("s"), "减去"], [de, ()=>u("i"), "交集"], [B, ()=>{
                s() && (sce.newPart(),
                e({
                    type: "new-part"
                }),
            ...
            , "打开"], [ge, ()=>{
                sce.selected[0] && "mesh" == sce.selected[0].userData.type ? Le(a ? a.name.replace(/\.[^/.]+$/, "") : "untitled") : alert("请先选择一个要导出的实体")
            }
            , "导出到STL"]]
              , [d,p] = (0,
            t.useReducer)((e=>e + 1), 0)
            ...
            }), "金宇陶JYT的CAD平台"), t.createElement("div", {
